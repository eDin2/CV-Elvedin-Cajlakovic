...
window.onload = function (e) {
	...
	if (document.cookie.indexOf('COOKIES_ACCEPTED') >= 0) {
		...
		cookie_notice_content += '<div class="cookie-notice-headline">Ja, auch diese Webseite verwendet Cookies</div>';

		cookie_notice_content += '<p>Indem Sie auf -Ja, ich stimme zu- klicken oder meine Webseite weiter nutzen stimmen Sie der Verwendung der Cookies zu.</p>';

		cookie_notice_content += '<p>Weitere Informationen, auch wie Sie die Verwendung von Cookies unterbinden k&ouml;nnen, entnehmen Sie bitte meiner <a href="./src/indexDatenschutz.html" class="cookie-notice-privacy-link">Datenschutzerkl&auml;rung</a>.</p>';
		...
		cookie_notice_content += '<p>Hier erfahren Sie alles über Datenschutz <a href="https://www.dsb.gv.at/gesetze-in-osterreich" class="cookie-notice-privacy-link">Gesetze-in-Oesterreich</a>.</p>';
